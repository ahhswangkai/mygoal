...
WECOM_WEBHOOK_URL=
WECOM_ENABLED=true
WECOM_PUSH_DAILY_AI=true
WECOM_PUSH_AI_REVIEW=true
WECOM_PUSH_LIVE_ALERTS=true
REQUEST_TIMEOUT=30
REQUEST_DELAY=2
MAX_RETRIES=3
ARK_API_KEY=
...
FAE_DAILY_AI_BATCH_SIZE=10
FAE_DAILY_AI_TIMEOUT=180
FAE_DAILY_AI_MAX_TOKENS=4096
FAE_DAILY_AI_MAX_RETRIES=0
FAE_DAILY_AI_THINKING=disabled
WECOM_PUSH_PREMATCH_AI=false
FAE_AI_REVIEW_ENABLED=true
FAE_AI_REVIEW_TIMEOUT=180
FAE_AI_REVIEW_MAX_TOKENS=4096
FAE_AI_REVIEW_MAX_RETRIES=0
FAE_AI_REVIEW_THINKING=disabled
FAE_REVIEW_MEMORY_DAYS=7
FAE_REVIEW_MEMORY_OBSERVATION_DAYS=3
FAE_REVIEW_MEMORY_MIN_PATTERN_DAYS=2
FAE_REVIEW_MEMORY_MIN_EVIDENCE=10
FAE_LEAGUE_HISTORY_DAYS=730
FAE_LEAGUE_HALF_LIFE_DAYS=180
FAE_LEAGUE_MIN_SAMPLES=30
FAE_LEAGUE_MAX_MATCHES=500
FAE_LEAGUE_GLOBAL_MAX_MATCHES=5000
EOF
  chmod 600 "$ENV_FILE"
else
