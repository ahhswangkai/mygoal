        ...
        try:
            ...
            if compact:
                projection = {
                    ...
                    'analysis.single_play': 1,
                    'analysis.single_secondary_play': 1,
                    'analysis.single_odds': 1,
                    'analysis.single_secondary_odds': 1,
                    'analysis.single_probability': 1,
                    'analysis.single_secondary_probability': 1,
                    ...
                    'analysis.high_confidence_single_recommendation': 1,
                    'analysis.draw_radar': 1,
                    'analysis.market_analysis': 1,
                    'analysis.evidence': 1,
                    'analysis.risks': 1,
                    'analysis.score_candidates': 1,
                    'analysis.special_markets.version': 1,
                    'analysis.special_markets.source': 1,
                    'analysis.special_markets.total_goals.available': 1,
                    'analysis.special_markets.total_goals.market': 1,
                    'analysis.special_markets.total_goals.model_version': 1,
                    'analysis.special_markets.total_goals.primary': 1,
                    'analysis.special_markets.total_goals.secondary': 1,
                    'analysis.special_markets.total_goals.confidence': 1,
                    'analysis.special_markets.total_goals.reason': 1,
                    'analysis.special_markets.total_goals.snapshot.updated_at': 1,
                    'analysis.special_markets.half_full.available': 1,
                    'analysis.special_markets.half_full.market': 1,
                    'analysis.special_markets.half_full.model_version': 1,
                    'analysis.special_markets.half_full.primary': 1,
                    'analysis.special_markets.half_full.secondary': 1,
                    'analysis.special_markets.half_full.confidence': 1,
                    'analysis.special_markets.half_full.reason': 1,
                    'analysis.special_markets.half_full.snapshot.updated_at': 1,
