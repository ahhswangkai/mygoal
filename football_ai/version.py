...
VERSION_MANIFEST = {
    ...
    "features": [
        ...
        "特殊玩法V2：总进球低/常规/高结构分层、2/3球市场基线降级与半全场方向可信度门禁",
        ...
        "正式证据对齐二串一：双选组选项依次服从护栏最终方向、真实穿盘、一球差和逐场主选证据，工作日全日取模型前二，周末按21点拆分早晚场各取前二",
        ...
        "排行榜买量时效修复：复盘继续保留不可变研判快照，赛前展示优先使用比赛库最新投注比例与赔率重算冷热指数",
        "一球差与双选统一：让平雷达确认后不再输出让胜/让负两头覆盖，高总球浅盘保留2:1/3:2路径，并补齐主队+1时的客队小胜判断",
    ],
    "learning_policy": {
        "minimum_samples": 10,
        "decrease_below": 0.60,
